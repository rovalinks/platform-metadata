#!/bin/bash
# ==============================================================================
# Script to provision GCP Compute resources for Label/Tag governance testing
...
# A Forwarding Rule needs an IP and a target. We will attach it to the Classic VPN.
...
echo "=============================================================================="
echo "All test resources provisioned successfully in $PROJECT!"#!/bin/bash
# ==============================================================================
# Script to provision GCP Compute resources for Label/Tag governance testing
# Project: payments-dev-1
# ==============================================================================
...
echo "=============================================================================="
echo "All test resources provisioned successfully in $PROJECT!"
