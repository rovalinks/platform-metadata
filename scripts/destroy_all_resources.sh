#!/bin/bash
# ==============================================================================
# Script to DESTROY all test resources safely
# ==============================================================================
...
echo "Deleting Compute Engine Resources..."
...
echo "Deleting Dataform Repository..."
gcloud dataform repositories delete $PREFIX-dataform --location=$REGION --project=$PROJECT --quiet || true

echo "Deleting Dataplex EntryGroup..."
gcloud dataplex entry-groups delete $PREFIX-entrygroup --location=$REGION --project=$PROJECT --quiet || true
